...
export default function Comparison({ controls, isLive, regions, resolutionLevels, selectedRegionId, setSelectedRegionId }) {
  return (
    <section className="grid gap-4 xl:grid-cols-2">
      ...
      <div>
        ...
        <p className="mt-2 text-center text-xs text-slate-500">
          Left panel is an illustrative diagram of the conventional approach.{" "}
          {isLive
            ? "Right panel is live backend output."
            : "Right panel is the client-side simulation — switch to Live Backend for real data."}
        </p>
      </div>
    </section>
  );
